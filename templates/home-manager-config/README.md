...
**This is a Home-Manager Configuration template based on Nix Flakes, flake-parts and using robinwalterfit/nix-home-modules.**
...
```bash
home-manager switch --flake .#<HM_USERNAME>
```
...
- More Links:
    ...
    - Home Manager Option Search: [https://home-manager-options.extranix.com/](https://home-manager-options.extranix.com/)
    ...
    - `nix-home-modules`: [https://github.com/robinwalterfit/nix-home-modules](https://github.com/robinwalterfit/nix-home-modules)
    ...
    - `sops-nix`: [https://github.com/Mic92/sops-nix](https://github.com/Mic92/sops-nix)
